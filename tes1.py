...
mycursor.execute("SELECT id, publicid, nama, tempat_lahir, tanggal_lahir, jenis_kelamin, darah, desa_id, desa_id, kawin, noktp, jalan, pendidikan_terakhir, pekerjaan, created, updated FROM member ")
